...
export ALERTS_RUN_DURING=${ALERTS_RUN_DURING:=""}
export ALERTS_EXIT_ON_FAILURE=${ALERTS_EXIT_ON_FAILURE:=False}
...
export TELEMETRY_FULL_PROMETHEUS_BACKUP=${TELEMETRY_FULL_PROMETHEUS_BACKUP:=False}
...
export HEALTH_CHECK_RUN_DURING=${HEALTH_CHECK_RUN_DURING:=during}
export HEALTH_CHECK_ONLY_FAILURES=${HEALTH_CHECK_ONLY_FAILURES:=False}

# Kubernetes object state health check configuration
export OBJECT_STATE_CHECK_INTERVAL=${OBJECT_STATE_CHECK_INTERVAL:=2}
export OBJECT_STATE_CHECK_RUN_DURING=${OBJECT_STATE_CHECK_RUN_DURING:=during}
export OBJECT_STATE_CHECK_EXIT_ON_FAILURE=${OBJECT_STATE_CHECK_EXIT_ON_FAILURE:=False}
export OBJECT_STATE_CHECK_ONLY_FAILURES=${OBJECT_STATE_CHECK_ONLY_FAILURES:=False}
export OBJECT_STATE_CHECK_NAME=${OBJECT_STATE_CHECK_NAME:=""}
export OBJECT_STATE_CHECK_KIND=${OBJECT_STATE_CHECK_KIND:=Pod}
export OBJECT_STATE_CHECK_OBJECT_NAME=${OBJECT_STATE_CHECK_OBJECT_NAME:=""}
export OBJECT_STATE_CHECK_NAMESPACE=${OBJECT_STATE_CHECK_NAMESPACE:=""}
export OBJECT_STATE_CHECK_LABEL_SELECTOR=${OBJECT_STATE_CHECK_LABEL_SELECTOR:=""}
export OBJECT_STATE_CHECK_CONDITION_TYPE=${OBJECT_STATE_CHECK_CONDITION_TYPE:=Ready}
export OBJECT_STATE_CHECK_CONDITION_STATUS=${OBJECT_STATE_CHECK_CONDITION_STATUS:=True}
