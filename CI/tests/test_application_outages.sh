...
function functional_test_application_outages {
  export WAIT_DURATION=5
  export DURATION=10
  export NAMESPACE="openshift-monitoring"

  container_name="app_out_test"
  $command-compose build application-outages
...
functional_test_application_outages